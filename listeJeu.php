<html>
  ...
  <body>
    ...
    $sql="SELECT * from JEU NATURAL JOIN EDITEUR NATURAL JOIN ESTEDITER";
    if(!$connexion->query($sql)) echo "Pb d'accès à la liste";
      ...
      <dl>
        ...
        echo "<dt style='font-style:italic'>".$row['NOMJ']."</dt><dd>Sortie le ".$row['DATESORTIE']." créé par ".$row['NOME']."</dd></dt>\n<br>";
      ?>
      </dl>
    <?php } ?>
  </body>
