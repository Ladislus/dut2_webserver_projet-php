...
INSERT INTO JEU     (NOMJ, DATESORTIE, DESCJ)                        VALUES ('The Legend of Zelda : Ocarina of Time', '1998-11-21', 'Trop bien ce jeu, c\'est l\'histoire du héros Zelda qui doit sauver la princess Link danc cet épopée épique.'),
                                                                            ...
                                                                            ('Metal Gear Solid V', '2015-09-01','Metal Gear Solid V ou simplement MGS5 est un jeu étrange où on doit tuer des méchants pas beaux.'),
                                                                            ('Devil May Cry 5', '2019-03-08', 'Dans ce 5ieme opus de DMC on incarne quelqu\'un avec des cheveux blancs, je sais pas j\'y ai jamais joué :('),
                                                                            ('Valkyria Chronicles', '2008-04-21','Valkyria Chronicles est un tactical game où vous incarnez le fils du héros de la précédente guerre, mais au lieu de protéger votre pays natal, vous devez protéger un
                                                                                                                  pays paumé. BEST GAME EVER selon Ladislas');
